...
beforeAll(async () => {
  ...
  mock.module("@opencode-ai/app/context/file", () => ({
    useFile: () => ({
      tree: {
        state: () => undefined,
  ...
  mock.module("@opencode-ai/ui/components/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@opencode-ai/ui/components/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@opencode-ai/ui/components/icon", () => ({ Icon: () => null }))
  mock.module("@opencode-ai/ui/components/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
