...
import { useLocal } from "@opencode-ai/app/context/local"
import { selectionFromLines, useFile, type FileSelection, type SelectedLineRange } from "@opencode-ai/app/context/file"
import { createStore, produce } from "solid-js/store"
import { SessionContextUsage } from "@opencode-ai/app/components/session-context-usage"
import { IconButton } from "@opencode-ai/ui/components/icon-button"
import { Button } from "@opencode-ai/ui/components/button"
import { Tooltip, TooltipKeybind } from "@opencode-ai/ui/components/tooltip"
import { Dialog } from "@opencode-ai/ui/components/dialog"
import { ResizeHandle } from "@opencode-ai/ui/components/resize-handle"
import { Tabs } from "@opencode-ai/ui/components/tabs"
import { Select } from "@opencode-ai/ui/components/select"
import { useCodeComponent } from "@opencode-ai/ui/context/code"
import { createAutoScroll } from "@opencode-ai/ui/hooks"
import { Mark } from "@opencode-ai/ui/components/logo"

import { DragDropProvider, DragDropSensors, DragOverlay, SortableProvider, closestCenter } from "@thisbeyond/solid-dnd"
import type { DragEvent } from "@thisbeyond/solid-dnd"
import { useSync } from "@opencode-ai/app/context/sync"
import { useTerminal, type LocalPTY } from "@opencode-ai/app/context/terminal"
import { useLayout } from "@opencode-ai/app/context/layout"
import { checksum, base64Encode } from "@opencode-ai/util/encode"
import { findLast } from "@opencode-ai/util/array"
import { useDialog } from "@opencode-ai/ui/context/dialog"
import { DialogSelectFile } from "@opencode-ai/app/components/dialog-select-file"
import FileTree from "@opencode-ai/app/components/file-tree"
import { useCommand } from "@opencode-ai/app/context/command"
import { useLanguage } from "@opencode-ai/app/context/language"
import { useNavigate, useParams } from "@solidjs/router"
import { UserMessage } from "@opencode-ai/sdk/v2"
import { useSDK } from "@opencode-ai/app/context/sdk"
import { usePrompt } from "@opencode-ai/app/context/prompt"
import { useComments } from "@opencode-ai/app/context/comments"
import { ConstrainDragYAxis, getDraggableId } from "@opencode-ai/app/utils/solid-dnd"
import { usePermission } from "@opencode-ai/app/context/permission"
import { showToast } from "@opencode-ai/ui/components/toast"
import { SessionHeader, SessionContextTab, SortableTab, FileVisual, NewSessionView } from "@opencode-ai/app/components/session"
import { navMark, navParams } from "@opencode-ai/app/utils/perf"
import { same } from "@opencode-ai/app/utils/same"
import { createOpenReviewFile, focusTerminalById } from "@opencode-ai/app/pages/session/helpers"
import { createScrollSpy } from "@opencode-ai/app/pages/session/scroll-spy"
import { createFileTabListSync } from "@opencode-ai/app/pages/session/file-tab-scroll"
import { FileTabContent } from "@opencode-ai/app/pages/session/file-tabs"
import {
  SessionReviewTab,
  StickyAddButton,
  type DiffStyle,
  type SessionReviewTabProps,
} from "@opencode-ai/app/pages/session/review-tab"
import { TerminalPanel } from "@opencode-ai/app/pages/session/terminal-panel"
import { terminalTabLabel } from "@opencode-ai/app/pages/session/terminal-label"
import { MessageTimeline } from "@opencode-ai/app/pages/session/message-timeline"
import { useSessionCommands } from "@opencode-ai/app/pages/session/use-session-commands"
import { SessionPromptDock } from "@opencode-ai/app/pages/session/session-prompt-dock"
import { SessionMobileTabs } from "@opencode-ai/app/pages/session/session-mobile-tabs"
import { SessionSidePanel } from "@opencode-ai/app/pages/session/session-side-panel"
import { useSessionHashScroll } from "@opencode-ai/app/pages/session/use-session-hash-scroll"
