...
impl VisionProcessor {
    ...
    pub async fn analyze_visual_context(&self, image_b64: &str, meta: &serde_json::Value) -> Result<String> {
        ...
        let req = Req {
            ...
            messages: vec![
                Msg { role: "system".into(), content: "Analyze visual context of Godot scenes and be precise.".into() },
        ...
        match resp {
            ...
            Ok(rsp) => Ok(format!("[Visual Analysis] API error status {}", rsp.status())),
